...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    private static final String CLICK_ACTION = "com.sam_chordas.android.quotelistwidget.CLICK";
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        if (action.equals(CLICK_ACTION)) {
            ...
            Intent i = new Intent(ctx, com.sam_chordas.android.stockhawk.ui.DetailStockActivity.class);
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId) {
        ...
        rv = new RemoteViews(context.getPackageName(), R.layout.stocks_widget);
