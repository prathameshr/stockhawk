...
public class StockWidgetService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new StockList(this.getApplicationContext(), intent);
    }
}

class StockList implements RemoteViewsService.RemoteViewsFactory {

    private Cursor mCursor;
    private final Context mContext;
    private final int mStockWidgetId;

    public StockList(Context context, Intent intent) {
        mContext = context;
        mStockWidgetId = intent.getIntExtra(AppWidgetManager.EXTRA_APPWIDGET_ID,
    ...
    public RemoteViews getViewAt(int position) {
        ...
        final int itemId = R.layout.stock_item;
