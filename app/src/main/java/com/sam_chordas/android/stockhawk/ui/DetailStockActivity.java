...
public class DetailStockActivity extends AppCompatActivity {
    ...
    private ValueLineChart graphChart;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        graphChart = (ValueLineChart) findViewById(R.id.graph_chart);
    ...
    private void onDownloadCompleted() {
        com.sam_chordas.android.stockhawk.ui.DetailStockActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
